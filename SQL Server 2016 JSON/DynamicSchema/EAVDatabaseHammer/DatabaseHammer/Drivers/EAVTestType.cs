...
{
    public class EAVTestType : ITestType
    {
        ...
        {
                SqlCommand cmd = new SqlCommand("dbo.stp_insert_custom_product_data_eav", conn);
                ...
                pCustomData.TypeName = "dbo.eav_payload_type";
        ...
        public void InititalizeTest(SqlConnection conn)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("TRUNCATE TABLE dbo.products; TRUNCATE TABLE dbo.products_custom_data_eav", conn);
        ...
        public int CheckResult(SqlConnection conn)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("SELECT COUNT(DISTINCT product_id) FROM dbo.products_custom_data_eav", conn);
                cmd.CommandType = CommandType.Text;
