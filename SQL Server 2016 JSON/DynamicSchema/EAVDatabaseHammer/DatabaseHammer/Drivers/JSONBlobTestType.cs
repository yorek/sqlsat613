...
{
    public class JSONBlobTestType : ITestType
    {
        ...
        public void InititalizeTest(SqlConnection conn)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("TRUNCATE TABLE dbo.products; TRUNCATE TABLE dbo.products_custom_data_blob", conn);
        ...
        public int CheckResult(SqlConnection conn)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("SELECT COUNT(DISTINCT product_id) FROM dbo.products_custom_data_blob", conn);
                cmd.CommandType = CommandType.Text;
