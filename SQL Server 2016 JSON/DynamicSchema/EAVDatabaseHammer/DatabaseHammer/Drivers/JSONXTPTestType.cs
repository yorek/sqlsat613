...
{
    public class JSONXTPTestType : ITestType
    {
        ...
        public void InititalizeTest(SqlConnection conn)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("DELETE FROM dbo.products_xtp; DELETE FROM dbo.products_custom_data_json_xtp", conn);
        ...
        public int CheckResult(SqlConnection conn)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("SELECT COUNT(DISTINCT product_id) FROM dbo.products_custom_data_json_xtp", conn);
                cmd.CommandType = CommandType.Text;
